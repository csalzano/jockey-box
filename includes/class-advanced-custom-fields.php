	...
	function register_acf_field_groups() {
		if(function_exists("register_field_group"))
		{
			...
			register_field_group(array (
				...
				'fields' => array (
					array (
						'key' => 'field_55c8d089e3213',
						'label' => 'Below brewery grid',
						'name' => 'below-brewery-grid',
						'type' => 'text',
						'instructions' => 'This is the yellow text on the brown background directly below the brewery logo grid.',
						'default_value' => '',
						'placeholder' => '',
						'prepend' => '',
						'append' => '',
					...
					array (
						'key' => 'field_55c8d0a1e3214',
						'label' => 'Ticket image',
						'name' => 'ticket-image',
						'type' => 'text',
						'instructions' => 'An image that is also a link to buy tickets, or an image that says tickets are sold out.',
						'default_value' => '',
						'placeholder' => '',
						'prepend' => '',
						'append' => '',
					...
					array (
						'key' => 'field_55c8d10ce3215',
						'label' => 'Lower content',
						'name' => 'lower-content',
						'type' => 'text',
						'instructions' => 'This content appears below the ticket image on a green background.',
						'default_value' => '',
						'placeholder' => '',
						'prepend' => '',
						'append' => '',
